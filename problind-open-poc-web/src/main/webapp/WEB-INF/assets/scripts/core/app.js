...
var App = function () {
    ...
    var handleTheme = function () {
        ...
        var setLayout = function () {
            ...
            var sidebarOption = $('.sidebar-option', panel).val("fixed");
            var headerOption = $('.header-option', panel).val();
            var footerOption = $('.footer-option', panel).val("fixed");
    ...
    return {
        ...
        blockUI: function (options) {
            ...
            if (options.iconOnly) {
                ...
                html = '<div class="loading-message ' + (options.boxed ? 'loading-message-boxed' : '')+'"><span>&nbsp;&nbsp;' + (options.message ? options.message : 'Aguarde...') + '</span></div>';
            } else {    
                html = '<div class="loading-message ' + (options.boxed ? 'loading-message-boxed' : '')+'"><img style="" src="../assets/img/loading-spinner-grey.gif" align=""><span>&nbsp;&nbsp;' + (options.message ? options.message : 'Aguarde...') + '</span></div>';
            }
        ...
        startPageLoading: function(message) {
            $('.page-loading').remove();
            $('body').append('<div class="page-loading"><img src="../assets/img/loading-spinner-grey.gif"/>&nbsp;&nbsp;<span>' + (message ? message : 'Aguarde...') + '</span></div>');
        },
